...
**`세나`** 이하 **"당사"** 는 다음 목적을 위하여 개인정보를 처리하고 있으며, 다음 목적 이외의 용도로는 사용하지 않습니다.
...
| 처리 목적 | 처리 항목
| ---------------------------------------------------------------- | --------------------------------------------------------------- |
| Discord 관련 서비스 제공| 디스코드 유저 ID, 디스코드 서버 ID, 디스코드 채널 ID | 명령어 사용을 위한 수집 |
...
| ----------------- | ---------------------------------------------------- | ----------- | ---------------- |
| **MongoDB, Inc.** | 디스코드 유저 ID, 디스코드 서버 ID, 디스코드 채널 ID | 서비스 제공 | 탈퇴 후 최대 1년 |
